...
export default function Footer() {
    ...
    const socialLinks = [
        ...
        {
            icon: Github,
            href: "https://github.com/Ayush-Patel-56",
            label: "GitHub",
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    >
                        <p className="text-white/80 text-lg">
                            Built by <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-300 font-semibold">Ayush Patel</span>
                        </p>
                        <p className="text-white/60 text-sm">
                            ...
                            The source code is available on <a href="https://github.com/Ayush-Patel-56/Portfolio-Profile" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">GitHub</a>.
                        </p>
                    ...
                    >
                        © {currentYear} Ayush Patel. All rights reserved.
                    </motion.p>
                </div>
            </div>
        </footer>
